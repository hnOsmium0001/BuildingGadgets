...
public interface IBlockProvider {
    ...
    /**
     * @param origin the new translate
     ...
     * <p>{@code pos.add(this.getTranslation())}</p>
     */
    ...
    /**
     * @return the translate used for translation done to the parameter of {@link #at(BlockPos)}
    ...
    /**
     * <p>
     * The BlockPos will be translated by {@link #getTranslation()}.
     * </p>
     * <p>
